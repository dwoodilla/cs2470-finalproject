...
from model_interface import ImageCaptionModel, accuracy_function, loss_function
...
def save_model(model, args):
    ...
    keras.models.save_model(model, args.chkpt_path)
...
def compile_model(model, args):
    ...
    optimizer = keras.optimizers.get(args.optimizer).__class__(learning_rate = args.lr)
    model.compile(
        optimizer   = optimizer,
        loss        = loss_function,
